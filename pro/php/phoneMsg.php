...
class Miaodi
{
    ...
    private $miaodi_token = "ba7a4985d7614f55a3b7b3dcf2b67af9";
    private $miaodi_sid = "2af551e007e24bf39cf706dce7ba1893";
    ...
    public function sendSMS($to, $content, $param)
    {
        ...
        $to = $to;
        $poststr = 'accountSid=' . $this->miaodi_sid . '&smsContent=' . $smsContent . '&to=' . $to . '×tamp=' . $timestamp . '&sig=' . $sig . '&respDataType=JSON';
...
//用法
$str = "您的验证码为{1}，请于{2}分钟内正确输入，如非本人操作，请忽略此短信。";
$md = new Miaodi();
$md->sendSMS('17826877713',$str,['123456','1']);
?>